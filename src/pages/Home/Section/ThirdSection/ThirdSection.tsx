...
const ThirdSection = () => {
  ...
  return (
    <>
      <div className="relative w-[100vw] lg:h-[1280px] mt-8 sm:py-16 lg:py-0   ">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1728 1268"
          className="w-full lg:h-full  flex-shrink-0 fill-[#084525] stroke-black stroke-[1px] relative sm:h-[100vh] "
        >
        ...
        <div className="absolute top-4/6 left-1/2 transform -translate-x-1/2 w-[1177px] lg:h-[618px]  -translate-y-1/2 mx-auto grid grid-cols-2 place-items-center   justify-between sm:w-[100vw] lg:px-9   sm:-translate-y-60  ">
          <div className="flex align-middle ">
            <div className="flex flex-col items-start w-[212px] lg:gap-7 sm:gap-0 ">
              <p className="w-[159px] text-[#A76E50] font-poppins lg:text-[36px] font-normal leading-[58px] tracking-[4.32px] sm:text-[25px] md:text-[30px]">
                Brewed{" "}
              </p>
              <span className=" text-[#A76E50] text-center font-poppins lg:text-[48px] font-normal leading-[78px] sm:text-[35px] md:text-[40px] ">
                For You
              </span>
              <div className="w-[500px] text-[#FFF]  font-poppins text-[36px] font-normal leading-[58px] tracking-[4.32px] sm:text-[25px] ">
                <p>{text[number - 1]?.heading}</p>
              </div>
              <div className="w-[296px] text-[#E6E5E6] font-poppins text-[16px] font-normal leading-[26px] sm:text-[10px]">
                {text[number - 1]?.detail}
              </div>
              <button className="flex justify-center items-center gap-2 lg:px-6 lg:py-2 rounded-[24px] bg-[#A76E50] text-[#fff] sm:px-2 sm:py-2 ">
                See All
              </button>
              <div className="flex items-center gap-2 w-[167px] h-[59px] ">
                ...
                <svg
                  ...
                  viewBox="0 0 24 25"
                  fill="none"
                  className="lg:w-6 lg:h-6 cursor-pointer sm:w-4 sm:h-4"
                ...
                <div className="flex items-center justify-center relative">
                  <p className="text-white font-poppins lg:text-[18px] font-medium leading-[32px] tracking-[3.24px] absolute top-[-30px] sm:text-[12px]">
                    {number}
                  </p>
                  <div className="w-[48px] h-[1px] bg-[#4A494B] rotate-[-45deg]"></div>
                  <p className="text-[#4A494B] font-poppins lg:text-[18px] font-medium leading-[32px] tracking-[3.24px] absolute bottom-[-30px] sm:text-[12px]">
                    4
                  </p>
                </div>
          ...
          <div className="lg:w-[511.893px] lg:h-[511.893px] flex-shrink-0 bg-[url('/images/blankcup.png')] bg-cover relative sm:w-[30vw] sm:h-[30vh]">
            <div className="lg:w-[172.065px] lg:h-[172.065px] flex-shrink-0 bg-[url('/images/logo.png')] bg-lightgray bg-cover bg-center absolute top-1/2 lg:left-1/2 transform -translate-x-1/2 -translate-y-1/2 sm:w-[10vw] sm:h-[10vh] sm:right-[15%]"></div>
          </div>
          <div className="lg:w-[716px] lg:h-[606px] absolute right-0 -z-10 flex-shrink-0 bg-[url('/images/beans.png')] bg-cover bg-center bg-no-repeat sm:w-[200px] sm:h-[200px] sm:right-20"></div>
        </div>
      </div>
    </>
  );
