...
const FifthSection = () => {
  return (
    <div className="relative w-[100vw] h-[60vh] flex-shrink-0 -z-10 overflow-hidden flex flex-col items-center justify-center">
      <p className="absolute top-1/2 w-[80%] max-w-4xl text-center text-[#F2F2F2] font-[Poppins] text-[clamp(1rem,2vw,1.25rem)] font-normal leading-[clamp(1.5rem,3vw,2rem)] tracking-[0.1em] z-10">
