...
const Footer = () => {
  return (
    <div className="w-[100vw] h-[31.25rem] flex-shrink-0 bg-[#052E19] flex flex-col justify-center items-center py-[1.5rem] px-[4.5rem]">
      <div className="flex justify-between w-[83.33%] items-center">
        <div className="flex flex-col items-start w-[15.3125rem] gap-[0.9375rem]">
          <h4 className="self-stretch text-[#FFF] font-[Poppins] text-[1.5rem] font-medium leading-[2.4375rem]">
            Contact
          </h4>
          <p className="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-[1.5rem] h-[1.5rem] fill-none"
              viewBox="0 0 24 24"
            >
              <path
            ...
            <span className="text-[#FFF] text-center font-[Poppins] text-[1rem] font-normal leading-[1.625rem] ml-[0.125rem]">
              +977 123-456-789
            </span>
          </p>
          <p className="flex items-center">
        ...
        <div className="flex flex-col items-center">
          <h5 className="text-[#FFF] text-center font-[Poppins] text-[1.25rem] font-normal leading-[2rem] tracking-[0.1rem]">
            Namche Bazar, Solukhumbu
          </h5>
          <h5 className="text-[#FFF] text-center font-[Poppins] text-[1.25rem] font-normal leading-[2rem] tracking-[0.1rem] items-center">
            Nepal
          </h5>
          <div className="w-[7.5rem] h-[7.5rem] flex-shrink-0 bg-[url('/images/logo.png')] bg-center bg-cover"></div>
        </div>
        <div className="flex flex-col items-center">
          <h4 className="self-stretch text-[#FFF] text-center font-[Poppins] text-[1.5rem] font-medium leading-[2.4375rem]">
            Follow Us
          </h4>
          <div className="flex">
      ...
      <div className="flex w-[100vw] items-center align-middle gap-[0.125rem] mt-[1.5rem]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-[30.8125rem] h-[4.75rem] flex-shrink-0 fill-black"
          viewBox="0 0 493 76"
          fill="none"
        >
          <path
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-[20.90625rem] h-[3.707125rem] flex-shrink-0 fill-black"
          viewBox="0 0 335 60"
          fill="none"
        >
          <path
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-[37.1875rem] h-[7.3125rem] flex-shrink-0 fill-black mb-[0.5625rem]"
          viewBox="0 0 595 117"
        >
      ...
      <div className="flex justify-between w-[91.67%] mx-auto mt-[1.5rem]">
        <p className="text-[#929292] text-center font-[Poppins] text-[1rem] font-normal leading-[1.625rem]">
          &copy; 2025 Yak Buck Coffee. All rights reserved
        </p>
        <p className="text-white text-center font-[Poppins] text-[1rem] font-normal leading-[1.625rem] flex justify-between items-center">
          Designed and Developed By{" "}
          <div className="w-[2.625rem] h-[0.8161875rem] bg-[url('/images/webx.png')] bg-gray-300 bg-cover bg-center ml-[0.125rem]"></div>
        </p>
      </div>
    </div>
  );
